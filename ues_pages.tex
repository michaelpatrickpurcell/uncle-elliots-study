...
\begin{center}
\begin{tikzpicture}
\node[draw, line width=2mm, inner sep=0pt] at (0,0) {\includegraphics[width=0.9\textwidth]{Images/newtons_cradle.png}};
\end{tikzpicture}
%\includegraphics[width=0.625\textwidth]{Images/baseball.png}
\end{center}
...
%Handout files are available for free at
%
%\color{Blue}
%\href{https://armigergames.itch.io/uncle-elliots-study}{armigergames.itch.io/uncle-elliots-study}
%\color{black}
...
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=Yellow] at (0,0) {};
...
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=Yellow] at (0.4cm,-1.0cm) {};
...
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=gray] at (0.4cm,0) {};
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=Yellow] at (0.8cm,0) {};
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=gray] at (1.2cm,0) {};
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=gray] at (1.6cm,0) {};
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=Yellow](a) at (2cm,0) {};

\draw[ultra thick, ->] (1cm, -0.3cm) -- (1cm, -0.7cm);

\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=Yellow] (b) at (0,-1.0cm) {};
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=Yellow] at (0.4cm,-1.0cm) {};
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=gray] at (0.8cm,-1.0cm) {};
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=Yellow] at (1.2cm,-1.0cm) {};
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=gray] at (1.6cm,-1.0cm) {};
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=gray] at (2cm,-1.0cm) {};
...
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=gray] at (0,0) {};
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=Yellow] at (0.4cm,0) {};
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=gray] at (0.8cm,0) {};
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=gray] at (1.2cm,0) {};
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=gray] at (1.6cm,0) {};
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=Yellow](a) at (2cm,0) {};
...
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=gray] at (0.8cm,-1.0cm) {};
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=gray] at (1.2cm,-1.0cm) {};
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=Yellow] at (1.6cm,-1.0cm) {};
...
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=gray] at (1.2cm,0) {};
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=gray] at (1.6cm,0) {};
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=Yellow](a) at (2.0cm,0) {};
...
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=gray] at (1.2cm,-1.0cm) {};
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=gray] at (1.6cm,-1.0cm) {};
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=Yellow] at (2.0cm,-1.0cm) {};
...
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=Yellow] at (1.6cm,-1cm) {};
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=Yellow](a) at (2cm,-1cm) {};

\draw[ultra thick, ->] (1cm, -1.3cm) -- (1cm, -1.7cm);

\node at (-0.6cm, -2cm) {\setmainfont{noto sans symbols 2}\normalsize☞};

\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=Yellow] at (0,-2cm) {};
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=Yellow] at (0.4cm,-2cm) {};
...
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=Yellow](a) at (2cm,-2cm) {};
...
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=Yellow] at (0,-3cm) {};
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=gray] at (0.4cm,-3cm) {};
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=Yellow] at (0.8cm,-3cm) {};
...
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=Yellow] at (0.4cm,-4cm) {};
...
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=Yellow] at (1.6cm,-4cm) {};
\node[inner sep=0pt, minimum width=0.4cm, circle, draw, thick, fill=Yellow](a) at (2cm,-4cm) {};
\end{tikzpicture}
\end{center}

The clues that should suggest this solution to your player are hidden in the letter that they received from Uncle Elliot.
...
%SW & $\rightarrow$ & Bear & $\rightarrow$ & Beer & $\rightarrow$ & 1\\
%SE & $\rightarrow$ & Spiders & $\rightarrow$ & Sliders & $\rightarrow$ & 8\\
%NE & $\rightarrow$ & Flies & $\rightarrow$ & Fries & $\rightarrow$ & 3\\
%E & $\rightarrow$ & Snakes & $\rightarrow$ & Shake & $\rightarrow$ & 2\\
%\end{tabular}
%\end{center}
...
\begin{center}
\begin{tikzpicture}
\pic[scale=0.5, transform shape] at (0,0) {plugboard};
\end{tikzpicture}
\end{center}
...
%\textit{You find your clothes in a pile where you were standing when you first activated the device. Uncle Elliot will need a robe.}
